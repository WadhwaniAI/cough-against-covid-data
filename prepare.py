...
def parse_args():
    ...
    parser.add_argument('--links_path', '-lp', type=str, help='Path to the links.txt file')
    parser.add_argument('--output_dir', '-od', type=str, help='Path to the output directory')
...
def download_files(links_path, output_dir):
    ...
    with open(links_path, 'r') as f:
        for i, line in enumerate(f):
            # Only lines with http in the beginning are links, also remove spaces
            # around and in between in each line
